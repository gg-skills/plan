 ...
 * @example
 * ```bash
 * npx tsx .agents/skills/plan/scripts/render-markdown-html.ts --input .plans/.../plan-foo.md
 * npx tsx .agents/skills/plan/scripts/render-markdown-html.ts --dir .plans/.../
 * ```
 *
